...
##Database download
The hostile, kraken, humann, and metaphlan databases need to be downloaded
...
sbatch Alpine_Humann_Database_._Download.sh

chmod +x Alpine_Metaphlan_Database_Download.sh
sbatch Alpine_Humann_Database_Download.sh
```
